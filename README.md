...
Penguins of Tangram is designed for children ages 4–10: Arrow keys or WASD move, Space/Up jumps, and P or Escape pauses. The in-game How to play panel explains keyboard and touch controls, sound, reduced motion, route notes, and the parent-confirmed reset action. Progress and optional route notes stay on the device; no account, network service, advertising, chat, or tracking is required.
