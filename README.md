...
Penguins uses Arrow keys or WASD to move, Space/Up to jump, and P or Escape to pause. Its Sound toggle persists locally beside campaign progress; reduced-motion preferences remove world bobbing, rotation, and camera shake. To reset the campaign, clear the site's local storage for `penguins-of-tangram.progress`.
