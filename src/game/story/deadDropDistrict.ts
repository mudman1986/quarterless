...
export const DEAD_DROP_DISTRICT: StoryChapter = {
  ...
  missions: [
    ...
    },
    {
      ...
      primaryGoal: 'Stay on the fake ambulance until it reaches the chop garage, then pin it in the garage and hold the box long enough to force a stop.',
      secondaryPressure: 'Keep it in sight without giving it a clean lane out; the trap opens once the ambulance reaches the garage.',
      ...
      prototypeRuntime: {
        ...
        objectives: [
          {
            kind: 'tail',
            description: 'Keep the fake ambulance in sight until it reaches the chop garage',
            seconds: 12,
          },
          {
            kind: 'capture',
            description: 'Pin the ambulance in the chop garage and hold it there long enough to force a stop',
            seconds: 3,
          },
        ],
        reward: 4200,
      ...
      prototypeScript: {
        ...
        stages: [
          {
            id: 'false-ambulance-tail',
            title: 'Tail the ambulance',
            primaryActorId: 'false-ambulance-van',
            districtState: {
              label: 'Stay on the fake ambulance as it heads for the chop garage',
              summary: 'Keep the ambulance in sight and don\'t let it slip away before the garage trap closes.',
            },
            actors: [
              {
                kind: 'vehicleRoute',
            ...
            nextWhen: { kind: 'tailSeconds', seconds: 12 },
          },
          {
            id: 'false-ambulance-capture',
            title: 'Box it in',
            primaryActorId: 'false-ambulance-van',
            districtState: {
              label: 'Pin the ambulance in the chop garage',
              summary: 'The ambulance is at the chop garage; cut off its lane and keep it boxed in until it can\'t slip out.',
            },
            actors: [
              {
                kind: 'vehicleRoute',
            ...
            nextWhen: { kind: 'captureSeconds', seconds: 3 },
          },
        ],
      },
    },
